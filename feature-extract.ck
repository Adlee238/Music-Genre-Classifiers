...
// Feature vector: Centroid, Flux, RMS, RollOff, ZeroX, Chroma, Kurtosis, SFM, MFCC
// comment out features you don't wish to use (if MFCC, also comment out its coefficients)
...
//fft =^ ZeroX zerox =^ combo;    // size 1
//fft =^ Chroma chroma =^ combo;    // size 12
//fft =^ Kurtosis kurtosis =^ combo;    // size 1
